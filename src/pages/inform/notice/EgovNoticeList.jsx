...
function EgovNoticeList(props) {
    ...
    = useState(location.state?.searchCondition || { bbsId: bbsId, pageIndex: 1, searchCnd: '0', searchWrd: '' });// 기존 조회에서 접근 했을 시 || 신규로 접근 했을 시
        ...
        <div className="container">
            <div className="c_wrap">
                ...
                <div className="layout">
                    ...
                    <div className="contents NOTICE_LIST2" id="contents">
                        {/* <!-- 본문 --> */}
