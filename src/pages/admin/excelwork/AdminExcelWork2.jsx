...
function AdminExcelWork2(props) {

    const showToast = (_val) => {
        toast(_val, { delay: 550, autoHideDelay: 550 });
    }
    ...
    const retrieveDetail = () => {
        ...
        if (modeInfo.mode === CODE.MODE_CREATE) {
            ...
            setBoardDetail({ bbsId: bbsId, nttSj: "EX15", nttCn: "EX15" });
            return;
        }
            ...
            <div className="c_wrap">
                ...
                <div className="layout">
                    ...
                    <div className="contents contents_admin SITE_GALLARY_VIEW NOTICE_LIST2" id="contents">
                        ...
                        <h2 className="tit_2">과제별 상세정보 Excel Upload</h2>
                        ...
                        <div style={{ fontSize: '14px', marginBottom: '20px', marginTop: '20px', backgroundColor: '#efefef', color: '#111', padding: '20px' }}>
                            ...
                            <p style={{ padding: '10px' }}>과제별 상세정보 업로드 입니다. 최대 5분 업로드 시간 예상 합니다.</p>
                            <p style={{ padding: '10px' }}>엑셀파일명은 ex15.xlsx 으로 고정되어 있습니다.</p>
...
export default AdminExcelWork2;