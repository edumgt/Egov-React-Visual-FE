...
function AdminExcelWork5(props) {
    ...
    const retrieveDetail = () => {
        ...
        if (modeInfo.mode === CODE.MODE_CREATE) {
            ...
            setBoardDetail({ bbsId: bbsId, nttSj: "EX42", nttCn: "EX42" });
            return;
        }
                 ...
                 <div className="layout">
                    <EgovLeftNav />
                        <div className="contents contents_admin SITE_GALLARY_VIEW NOTICE_LIST2" id="contents">
                            ...
                            <h2 className="tit_2">핵심기술 로드맵 자료 Excel Upload</h2>
                            ...
                            <div style={{fontSize:'14px',marginBottom:'20px',marginTop:'20px',backgroundColor:'#efefef',color:'#111',padding:'20px'}}>
                                <p style={{padding:'10px'}}>핵심기술 로드맵 자료 업로드 입니다. 최대 1분 소요 예상 합니다. 엑셀파일명은 ex42.xlsx 으로 고정되어 있습니다.</p>
...
export default AdminExcelWork5;