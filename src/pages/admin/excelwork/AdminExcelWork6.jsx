...
function AdminExcelWork6(props) {
    ...
    const retrieveDetail = () => {
        ...
        if (modeInfo.mode === CODE.MODE_CREATE) {
            ...
            setBoardDetail({ bbsId: bbsId, nttSj: "EX55", nttCn: "EX55" });
            return;
        }
                 ...
                 <div className="layout">
                    <EgovLeftNav />
                        <div className="contents contents_admin SITE_GALLARY_VIEW NOTICE_LIST2" id="contents">
                            ...
                            <h2 className="tit_2">사용후핵연료 저장/처분 기술수준 Excel Upload</h2>
                            ...
                            <div style={{fontSize:'14px',marginBottom:'20px',marginTop:'20px',backgroundColor:'#efefef',color:'#111',padding:'20px'}}>
                                <p style={{padding:'10px'}}>사용후핵연료 저장/처분 기술수준 자료 업로드 입니다. 최대 1분 소요 예상 합니다. 엑셀파일명은 ex55.xlsx 으로 고정되어 있습니다.</p>
                                <p style={{padding:'10px'}}>모든 cell은 한줄만 인식 됩니다. cell 내부 2줄 이상의 문장은 한줄로 만드셔야 합니다.</p>
                                <p style={{padding:'10px'}}>모든 cell은 텍스트 포맷만 인식 됩니다. 엑셀의 산술식, 주석, 특수문자(싱글 쿼테이션) 등 서버에서 인식 불가 입니다.</p>
                                <p style={{padding:'10px'}}>백분율(%) 의 값은 100을 곱하여, 문자로 저장해야 합니다. 
                                &nbsp;&nbsp;
                                
                                <input id="nttSj" name="nttSj" type="hidden"
                                        defaultValue="EX55"></input>
...
export default AdminExcelWork6;