...
function EgovAdminBoardEdit(props) {
    ...
    const bbsAttrbCodeOptions = [{ value: "", label: "선택" }, { value: "BBSA02", label: "자료실" }, { value: "BBSA03", label: "일반게시판" }];
        ...
        <div className="container">
            <div className="c_wrap">
                ...
                <div className="layout">
                    ...
                    <div className="contents contents_admin BOARD_CREATE_REG" id="contents">
                        {/* <!-- 본문 --> */}
