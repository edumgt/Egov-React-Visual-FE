        ...
        <div className="container">
            ...
            <div>&nbsp;</div>
                <div className="layout">
                    ...
                    <div className="contents contents_admin BOARD_CREATE_REG NOTICE_LIST2" id="contents">
                            <h2 className="tit_2">관리자메뉴자 암호변경</h2>
                            <div className="board_view2">
                            <dl>
                                <dt><label htmlFor="oldPassword">기존 암호</label><span className="req">필수</span></dt>
                                <dd>
                                    <input className="f_input2 w_full" type="password" name="oldPassword" 
                                    title="" id="oldPassword" placeholder="" 
                            ...
                            <dl>
                                ...
                                <dd>
                                    <input className="f_input2 w_full" type="password" name="newPassword" 
                                    title="" id="newPassword" placeholder=""
