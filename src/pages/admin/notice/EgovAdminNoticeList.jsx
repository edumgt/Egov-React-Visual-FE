...
function EgovAdminNoticeList(props) {
    ...
    = useState(location.state?.searchCondition || { bbsId: bbsId, pageIndex: 1, searchCnd: '0', searchWrd: '' });
        ...
        <div className="container">
            ...
            <div>&nbsp;</div>
                ...
                <div className="layout">
                    ...
                    <div className="contents contents_admin NOTICE_LIST2" id="contents">
                        ...
                        <div className="condition2">
                            <ul>
                                    ...
                                    <label className="f_select" htmlFor="sel1">
                                        <select id="sel1" title="조건"
                                            ...
                                            onChange={e => {
                                                ...
                                                console.log(cndRef.current.value);
                                            }}
                                        >
                                ...
                                {masterBoard.bbsUseFlag === 'Y' &&
                                    <li>
                                        <Link to={URL.ADMIN_NOTICE_CREATE} state={{ bbsId: bbsId }}
